...
public class NewProductAdapter extends BaseAdapter {
    ...
    private List<NewProductResponse.ProductListBean> newList = new ArrayList<>();

    public NewProductAdapter(List<NewProductResponse.ProductListBean> list) {
        this.newList = list;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if(convertView == null){
            convertView = View.inflate(parent.getContext(),R.layout.new_product_listitem,null);
