 ...
 */
public class Category_Third_activity extends BaseActivity implements HttpLoader.HttpListener {


    private static final String TAG = "Category_Third_activity";
    ...
    protected void initView() {
        ...
        parentID = getIntent().getIntExtra("thrid_parentID", -1);
    }
