...
public class HotProductActivity extends BaseActivity implements HttpLoader.HttpListener, AdapterView.OnItemClickListener {
    ...
    private List<HotProductResponse.ProductListBean> list = new ArrayList<>();
    ...
    protected void initView() {
        ...
        hotProductAdapter = new HotProductAdapter(list);
        newProductLv.setAdapter(hotProductAdapter);
    ...
    protected void initData() {
        ...
        App.HL.get(ConstantsRedBaby.URL_HOTPRODUCT, params, HotProductResponse.class, ConstantsRedBaby.REQUEST_HOT_PRODUCT, HotProductActivity.this).setTag(this);
    }
    ...
    public void requestAndNotifyDataChanged() {
        changeState();
        HttpParams params = new HttpParams().put("page", "1").put("pageNum", "15").put("orderby", orderby);
        App.HL.get(ConstantsRedBaby.URL_HOTPRODUCT, params, HotProductResponse.class, ConstantsRedBaby.REQUEST_HOT_PRODUCT, this).setTag(this);
    }
